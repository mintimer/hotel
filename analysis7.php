...
<head>
    ...
    <body class="bgstaffreport"> 
                ...
                <ul class="navbar-nav mr-auto">              
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item disabled" href="#">Nation Of Employee</a>
        ...
        <div class="container bg-light" >
            <br>
            <h3>Analysis 7 : Nation Of Employee</h3>
            <h5 style="background-color: powderblue">จำนวนพนักงานส่วนต่างๆแบ่งตามสัญชาติ </h5>
