...
<html>
    ...
    <body class="bgstaffreport"> 
                ...
                <ul class="navbar-nav mr-auto">              
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item disabled" href="#">Staff In Position</a>
        ...
        <div class="container bg-light" >
            <br>
            <h3>Analysis 2 : Monthly Reservasion</h3>
            <h5 style="background-color: powderblue">จำนวนพนักงานในตำแหน่งต่างๆในโรงแรมแต่ละสาขา</h5> 
