...
<html>
    ...
    <body class="bgstaffreport"> 
                ...
                <ul class="navbar-nav mr-auto">              
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item disabled" href="#">Top 10 Duration</a>
        ...
        <div class="container bg-light" >
            <br>
            <h3>Analysis 9 : Top 10 Duration</h3>
            <h5 style="background-color: powderblue">จำนวนวันของคนที่เข้ามาใช้บริการของโรงแรมนานที่สุด 10 อันดับแรก </h5>
